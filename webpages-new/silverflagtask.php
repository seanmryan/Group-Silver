                ...
                <!--<div class="art-contentLayout">-->
                    <div class="art-content">
                        ...
                        <div class="art-Post-inner">
                                        ...
                                        <h3> Are you sure you would like to flag this task?</h3><div class="art-PostContent">
...
<form method="post">
<br/>Task Title:<br/> 
<input type="text" name="FlagReason" placeholder="Enter Reason for Flagging"/><br/>
<br/>Please Confirm:<br/> 
<input type="submit" name="confirm" value="Yes">
<input type="submit" name="confirm" value="No">
</form>

<?php
include('php/flagtask.php');
?>
