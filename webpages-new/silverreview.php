                ...
                <!--<div class="art-contentLayout">-->
                    <div class="art-content">
                        ...
                        <div class="art-Post-inner">
                                        ...
                                        <h3> Are you satisfied or dissatisfied with the completed task?</h3><div class="art-PostContent">
									

<!--This php code lists some details regarding the variable-->
<?php
$taskIDhref = $_GET['task_id'];
	...
	while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
		...
		<br></br>
		", $taskID, $title, $userID, $description, $claimDeadline, $submissionDeadline);
	}
	include('php/printcompletedfilelink.php');
?>

<form method="post">
<input type="submit" name="confirm" value="Satisfied">
<input type="submit" name="confirm" value="Dissatisfied">
</form>

<?php
include('php/reviewtask.php');
?>
