                ...
                <!--<div class="art-contentLayout">-->
                    <div class="art-content">
                        ...
                        <div class="art-Post-inner">
                                        ...
                                        <h3> Are you sure you would like to unpublish this task?</h3><div class="art-PostContent">
									

<!--Here we get some details of the selected task-->
<?php
...
<!--Here the confirmation buttons for unpublishing the task-->
<form method="post">
<input type="submit" name="confirm" value="Yes">
<input type="submit" name="confirm" value="No">
</form>

<!--The include to the php which punpublishes the task-->
<?php
include('php/unpublishtask.php');
?>
